<script lang="ts" setup>
    import {
        ...
        ResultLinkOptionsDto, Result, getBaseApiUrl
...
<template>
    <q-card class="section-create-form q-mb-lg">
        <q-card-section class="product-create__content">
            <div class="property-file-options row items-center q-gutter-md no-wrap ">
                <q-select
                    v-model="value"
                    ...
                    option-value="id"
                    color="primary"
                    class="property-file-options__select"
                    outlined
                    clearable
                    @clear="clearAll"
                    @add="addItem"
                ...
                >
                    <template v-slot:selected-item="scope">
                        <div class="property-file-options__item q-mr-xs q-mb-xs row items-center no-wrap">
                            <div
                                class="property-file-options__item__bg q-mr-sm"
                                :style="{backgroundImage: 'url('+ baseUrl + '/'+ scope.opt.path.path +')'}"
                            ></div>
                            <div class="property-file-options__item__text">
                                {{ scope.opt.value }}
                            </div>
                ...
                <q-icon
                    ...
                    name="delete"
                    size="20px"
                    class="property-file-options__icon cursor-pointer"
