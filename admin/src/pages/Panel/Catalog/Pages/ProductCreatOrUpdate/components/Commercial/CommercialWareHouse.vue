<script lang="ts" setup>
    ...
    import CounterWareHouseCreateOrUpdate
        from 'pages/Panel/Catalog/Pages/ProductCreatOrUpdate/components/Commercial/CounterWareHouseCreateOrUpdate.vue';
...
<template>
    <div>
        ...
        <q-dialog v-model="isCreateOrUpdate" @hide="closeCreateOrUpdate">
            <counter-ware-house-create-or-update
