            ...
            <div class="property-links-key row items-center q-gutter-md no-wrap ">
                ...
                >
                    <template v-slot:selected-item="scope">
                        <div class="property-links-key__item q-mr-xs q-mb-xs">
                            {{ scope.opt.valueKey }} - {{ scope.opt.value }}
                            <q-icon
                ...
                <q-icon
                    ...
                    name="delete"
                    size="20px"
                    class="property-links-key__icon cursor-pointer"
