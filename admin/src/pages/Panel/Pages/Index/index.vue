<script lang="ts" setup>
    import { getApiClientInitialParams, PagesControllerClient, PagesDto, PagesListDto, PagesType } from 'src/ApiClient/ApiClient';
    ...
    onMounted(() => {
        filters.value = {
            ...
            pagesType: route.query.pagesType ? (route.query.pagesType as PagesType) : null,
        };
        create();
    });
</script>
...
<template>
    <div class="container">
        ...
        <template v-else>
            <pages-table :rows="rows" :filters="filters" :count="count" :limit="limit" @update-page="updatePage" @on-delete="deleteUser" />
        </template>
