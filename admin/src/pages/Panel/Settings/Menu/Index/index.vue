<script lang="ts" setup>
    import {
        ...
        ResponseListSettingsMenuDto,
        SettingsMenuControllerClient,
        SettingsMenuDto,
    ...
    import { ISettingsMenu, IMenuFilter } from '../interface';
    ...
    const create = async () => {
        ...
        const result: ResponseListSettingsMenuDto | any = await api.get(
        ...
        if (!result.isSuccess) {
            ...
            rows.value =
                result.entity.entity.map((el: SettingsMenuDto) => {
                    return {
                        ...el,
                        isChecked: false,
                    };
...
<template>
    <div class="container">
        ...
        <q-btn color="primary" class="circle fixed" :to="getRouter(RouterName.SettingsMenuCreate)">
