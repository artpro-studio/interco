<script lang="ts" setup>
    ...
    import AttributeIndex from './components/AttributeIndex/AttributeIndex.vue';
    import { getApiClientInitialParams, ReferenceBookControllerClient, ReferenceBookDto } from '@/ApiClient/ApiClient';
    ...
    const form: Ref<ReferenceBookDto> = ref({
        id: null,
...
<template>
    <q-tabs v-model="tab" color="primary" active-color="primary" dense swipeable inline-label>
        ...
        <q-tab v-if="route.name === RouterName.ReferenceBookEdit" name="attributes" icon="edit_attributes" label="Атрибуты" />
    </q-tabs>
