<script lang="ts" setup>
    ...
    import { IReferenceBookFilter, IReferenceBook, ReferenceBookColumnsTable } from '../../interface';
    ...
    const props: {
        ...
        rows: {
            type: Array as PropType<IReferenceBook[]>,
            required: true,
        },
        filters: {
            type: Object as PropType<IReferenceBook>,
            required: true,
        },
        count: {
            type: Number,
    ...
    const columns = ReferenceBookColumnsTable;
