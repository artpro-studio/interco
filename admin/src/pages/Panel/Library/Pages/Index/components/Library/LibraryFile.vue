<script lang="ts" setup>
    ...
    const emit = defineEmits(['on-change-router', 'on-update', 'on-select', 'on-remove-select']);
    ...
    const onClick = () => {
        ...
        if (file.value.type === FileType.Directory) {
            ...
            emit('on-change-router', file.value.id);
        } else {
    ...
    <div class="library-file-components" @click="onClick">
        ...
        <q-menu touch-position context-menu>
            <q-list dense style="min-width: 100px">
                ...
                <q-item clickable v-close-popup @click="onSelect">
