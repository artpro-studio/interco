export default {
	...
	clientSupportBannerItem2Title: 'Способы связи',
	clientSupportBannerItem3Title: 'Удаленная поддержка',
	clientSupportBannerItem3Text: 'Возможность дистанционной диагностики и устранения неполадок через интернет',
}
