...
<template>
	<div class="contacts-form pt-8 pb-8">
		<div class="container">
			<section-title title="Форма обратной связи" color-text="black" class="contacts-form__title" style="margin-bottom: 40px;" />
			<div class="contacts-form__description">
				<p>Если у вас есть вопросы, предложения или вы хотите получить дополнительную информацию, пожалуйста, заполните форму ниже, и мы свяжемся с вами в ближайшее время</p>
			</div>
				...
				<q-form class="contacts-form__form">
					...
					<div class="contacts-form__form__bottom row no-wrap justify-between items-center">
						<div class="contacts-form__form__bottom__left">
							<div class="contacts-form__form__file">
								<input type="file" id="file" class="desctop-hide">
								<label for="file" class="contacts-form__form__file__content row no-wrap items-center">
							...
							<q-checkbox
								v-model="isChecked"
								class="contacts-form__form__checked"
