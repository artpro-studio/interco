...
@Entity({
    name: 'send_subscription_description',
})
export class SendsSubscriptionDescriptoinEntity extends DefaultBaseEntity {
    @ApiProperty({
        example: 'Значение',
        nullable: false,
    ...
    @ManyToOne(
        ...
        (sendsSubcription) => sendsSubcription.description
    )
