...
export class PagesIblockSectionRepository {
    constructor(
        @InjectRepository(PagesIblockSectionEntity)
        private readonly pagesIblockSectionRepository: Repository<PagesIblockSectionEntity>
    ) {}

    async getForIblockSlug(slug: string): Promise<PagesIblockSectionDto[]> {
