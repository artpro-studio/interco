...
export class PagesIblockRecordsRepository {
    constructor(
        @InjectRepository(PagesIblockRecordsEntity) private readonly pagesIblockRecordsRepository: Repository<PagesIblockRecordsEntity>
    ) {}

    async get(body: PagesIblockRecordsQuery): Promise<{count: number, limit: number, entity: PagesIblockRecordsDto[]}> {
        try {
