...
@Entity({
    name: 'pages_sections_description_value'
})
export class PagesSectionsDescriptionValueEntity extends DefaultBaseEntity {
    ...
    @ManyToOne(() => PagesSectionsEntity, (section) => section.description)
